...
const Products: React.FC<ProductPopupProps> = ({ id }) => {
        ...
        <div className="container flex flex-col gap-y-9">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-5 gap-y-6">
            {products.map((product: Product, index: number) => (
              <div
                key={`product-${index}`}
                className="flex flex-col rounded-xl overflow-hidden shadow-lg bg-white p-4 cursor-pointer items-center justify-center"
