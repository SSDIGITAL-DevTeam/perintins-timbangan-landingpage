  ...
  return (
    <main>
      ...
      <section className="py-8">
        <PromoSection id="discount-pekanbaru" waLink="https://wa.me/6281263083880?text=Halo%20Perintis%20Timbangan%20Pekanbaru,%20saya%20ingin%mengetahui%20lebih%banyak%20mengenai%20diskon%20ini"/>
      </section>
      ...
      {/* Product */}
      <Products id="whatsapp-pekanbaru" />
      ...
      <section className="flex flex-col py-10 px-4 sm:px-6 lg:px-8 overflow-x-hidden">
        <div className="w-full max-w-7xl mx-auto">
          <div className="aspect-w-16 aspect-h-9 rounded-xl overflow-hidden">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3989.64428359513!2d101.41621677568165!3d0.5351593636512784!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31d5ab4f71d4e7e7%3A0x54f8e59fee20a251!2sPUSAT%20TIMBANGAN%20PEKANBARU!5e0!3m2!1sid!2sid!4v1727851196840!5m2!1sid!2sid"
              style={{ border: 0 }}
