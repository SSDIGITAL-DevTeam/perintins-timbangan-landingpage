...
export const metadata: Metadata = {
  ...
  title: "Perintis Timbangan Pekanbaru | Landing Page",
...
export default function Layout({ children }: { children: React.ReactNode }) {
  return (
    <>
      <Whatsapp waLink="https://wa.me/6281263083880?text=Halo%20Perintis%20Timbangan%20Pekanbaru,%20saya%20ingin%20konsultasi%20produk" />
      {children}
    </>
  );
}
