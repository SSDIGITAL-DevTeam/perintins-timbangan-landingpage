...
export default function Home() {
  return (
    <main>
      ...
      {/* Product */}
      <Products id="whatsapp-palembang" />
      ...
      <section className="flex flex-col py-[50px] px-[2rem] overflow-x-hidden">
        ...
        <div className="flex flex-col md:flex-row gap-y-10 gap-x-0 lg:gap-y-0 md:gap-x-10 lg:gap-x-20 container justify-center items-center">
          <Link href="tel:6281362618899" target="_blank" className="bg-primary px-12 py-5 text-white rounded-full hover:bg-secondary transition-colors duration-300">
            +6281362618899
          </Link>
          <Link id="whatsapp-palembang" href="https://wa.me/6281362618899?text=Halo%20Perintis%20Timbangan%20Palembang,%20saya%20ingin%20konsultasi%20produk" target="_blank">
            <Image src={AssetWhatsapp} alt="Asset Whatsapp" className="w-[50px] md:w-[70px]" />
          </Link>
          <Link href="https://shopee.co.id/pusattimbanganbanten?uls_trackid=51a1shrn0152&utm_content=2i2iBrskb6ssd6NMrZRUStpEv35R" target="_blank">
            <Image src={AssetShopee} alt="Asset Shopee" className="w-[50px] md:w-[70px]" />
          </Link>
          <Link href="https://www.tokopedia.com/timbanganjakarta" target="_blank">
      ...
      <section className="flex flex-col py-10 px-4 sm:px-6 lg:px-8 overflow-x-hidden">
        <div className="w-full max-w-7xl mx-auto">
          <div className="aspect-w-16 aspect-h-9 rounded-xl overflow-hidden">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d1983.5126383576874!2d106.2477352!3d-6.1273008!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e41f5d940b2333f%3A0xae661981b4c09971!2sJl.%20Raya%20Serang%20-%20Jkt%20%26%20Jl.%20Nambo%2C%20Kaserangan%2C%20Kec.%20Ciruas%2C%20Kabupaten%20Serang%2C%20Banten%2042183!5e0!3m2!1sid!2sid!4v1732099712818!5m2!1sid!2sid"
              style={{ border: 0 }}
